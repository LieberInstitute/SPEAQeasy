...
![Relaxing time limit for all jobs](images/8.1_time.png)
...
![Relaxing time limit for one process](images/8.1_trim.png)
...
![Adding cluster-specific options](images/8.1_cluster.png)
