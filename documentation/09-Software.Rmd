...
|[nextflow](https://www.nextflow.io/docs/latest/getstarted.html) | 20.01.0 | `nextflow` |
|[R](https://cran.r-project.org/bin/linux/ubuntu/README.html#installation) | 4.1.2 | `Rscript` |
...
The following docker image versions are used in this pipeline, when it is installed via the "docker" or "singularity" [installation](#installation) modes. These images are automatically managed by SPEAQeasy.

| Image | Tag | Software |
|:-------------:| -----:| -----: |
    | libddocker/bioc_kallisto | 3.14 | R 4.1.2, Bioconductor 3.14, and Kallisto 0.46.1 |
