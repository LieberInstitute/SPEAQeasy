...
Mac OS users in particular may be missing the utility `wget` (and others), required for the SPEAQeasy installation. A solution on Mac is to install [brew](https://brew.sh/), and install the required utilities through `brew`:
...
brew install wget autoconf automake make gcc zlib bzip2 xz pcre openssl texinfo texlive

#  Install openJDK8 (Java) from a third-party repository
