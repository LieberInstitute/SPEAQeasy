...
After the main call, `nextflow /dcl01/lieber/ajaffe/Nick/RNAsp/main.nf`, each command option can be described line by line:
...
bash /dcl01/lieber/ajaffe/Nick/RNAsp/scripts/generate_logs.sh $PWD/run_brain_subset.log
```
