...
if ( ! file("${params.hisat_idx_output}/fa/${params.fa}").exists() ){ 
	...
	exit 1, "Please run reference_builder, then run main.nf. Run reference_builder.nf --> Example:  nextflow -C reference_builder.config run reference_builder.nf -profile standard --reference \"hg19\" "
...
//If file does not exists, launch process to create it
	...
	exit 1, "Please run reference_builder.nf, then run main.nf. Run reference_builder.nf --> Example: nextflow -C reference_builder.config run reference_builder.nf -profile standard --reference "hg19"nextflow -C reference_builder.config run reference_builder.nf -profile standard --reference "hg19"nextflow -C reference_builder.config run reference_builder.nf -profile standard --reference \"hg19\""
...
//If file does not exists, launch process to create it
	...
	exit 1, "Please run reference_builder.nf, then run main.nf. Run reference_builder.nf --> Example: nextflow -C reference_builder.config run reference_builder.nf -profile standard --reference \"hg19\""
...
/* Using the old way of triggering reference constructions */
	...
	exit 1, "Please run reference_builder.nf, then run main.nf. Run reference_builder --> Example: nextflow -C reference_builder.config run reference_builder.nf -profile standard --reference \"hg19\""
